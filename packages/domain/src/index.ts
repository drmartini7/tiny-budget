...
export const TransactionSchema = z.object({
  ...
  merchant: z.string().optional(), // Deprecated in favor of payeeId, kept for backward compatibility if needed
...
export const CreateTransactionSchema = TransactionSchema.omit({ id: true, createdAt: true, periodId: true }).extend({
  ...
  payeeName: z.string().optional(), // Helper for frontend to send name instead of ID
});
